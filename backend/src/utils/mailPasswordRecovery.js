...
const sendEmail = async (to, subject, text, html) => {
  try {
    const info = await transporter.sendMail({
      from: '"Coca Cola" <exequiel.miranda245@gmail.com>',
      to,
      subject,
      text,
      html,
...
<div style="font-family: Arial, sans-serif; text-align: center; background-color: #f4f4f9; padding: 20px; border: 1px solid #ddd; border-radius: 10px; max-width: 600px; margin: 0 auto;">
  ...
  <p style="font-size: 16px; color: #555; line-height: 1.5;">
    Hola, hemos recibido una solicitud para restablecer tu contraseña. Usa el código de verificación que se muestra a continuación para continuar con el proceso:
  </p>
  ...
  <p style="font-size: 14px; color: #777; line-height: 1.5;">
    Este código es válido por los próximos <strong>15 minutos</strong>. Si no solicitaste este correo, puedes ignorarlo con seguridad.
  </p>
